...
//            cout << "leftBoundLength" << this->leftBoundLength() << endl;
        ...
        LevelOrderNode(E btNode,BinaryTree<E> *tree){
    ...
    BinaryTreeLevelOrderPrinter(BinaryTree<E> *tree){
        this->tree = tree;
    ...
    void _fillNodes(){
        ...
        while (true) {
            ...
            bool notNull = false;
            cout << "元素个数是:"<< preRowNodes->size() << endl;
...
//            rowNodes = tempList;
    ...
    LevelOrderNode *_addNode(vector<LevelOrderNode *>*nodes,E btNode){
...
//                 cout << "rowString3----" << rowString.size();
    ...
    static void printerWithTree(BinaryTree<E> * tree){
